...
def call_file_theft():
   ...
   # Group_Name = tk.StringVar()
    ...
    frame_alpr = tk.LabelFrame(root, text=" --Process-- ", width=900, height=500, bd=5, font=('times', 14, ' bold '),bg="#FFAEB9")

    frame_alpr.place(x=400, y=100)
    l1=tk.Label(root,text="Area_Name",background="white",font=('times', 17, ' bold '),width=10)
    ...
    l2=tk.Label(root,text="Year",background="white",font=('times', 17, ' bold '),width=10)
    l2.place(x=500,y=250)
    Year=tk.Entry(root,bd=2,width=5,font=("TkDefaultFont", 17),textvar=Year)
    Year.place(x=800,y=250)
    

    
    l4=tk.Label(root,text="Sub_Group_Name",background="white",font=('times', 17, ' bold '))
    l4.place(x=500,y=350)
    # Sub_Group_Name=tk.Entry(root,bd=2,width=9,font=("TkDefaultFont", 20),textvar=Sub_Group_Name)
    # Sub_Group_Name.place(x=200,y=120)
    ...
    # monthchoosen = ttk.Combobox(root, width = 30,textvar=Sub_Group_Name )
    # monthchoosen['values'] = (' Motor Cycles/ Scooters', 
    #                       'Motor Car/Taxi/Jeep',
    #                       'Buses',
    #                       'Goods carrying vehicles (Trucks/Tempo etc)'
    #                           )
    # monthchoosen.place(x=800,y=350)  
